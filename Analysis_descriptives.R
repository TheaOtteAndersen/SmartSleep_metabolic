...
base_data$selfScoreCat[base_data$selfScore<=8] <- "1"
base_data$selfScoreCat[base_data$selfScore>=8 & base_data$selfScore<10]="2"
base_data$selfScoreCat[base_data$selfScore>=10 & base_data$selfScore<12]="3"
